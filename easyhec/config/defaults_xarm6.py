...
_C.dataset.xarm_real.urdf_path = "assets/xarm6.urdf"
_C.dataset.xarm_real.use_links = [0, 1, 2, 3, 4, 5, 6,]
...
_C.model.rbsolver.init_Tc_c2b = [[1.0, 0.00, 0.00, -0.5],
                                [0.0, -0.90630779, -0.42262, 0.0117],
                                [0.0, 0.4226, -0.9063, 1.208],
                                [0.0, 0.0, 0.0, 1.0]]

_C.model.rbsolver.lrs = []
_C.model.rbsolver.mesh_paths = ["assets/xarm_description/meshes/xarm6/visual/base.stl",
...
_C.model.space_explorer.K = [[605.44445801, 0.000000000, 328.51901245],
                             [0.0000, 605.21270752, 239.07077026],
                             [0.000, 0.0000, 1.0]]
...
_C.model.rbsolver_iter.start_qpos = [0, 0, 0, 0, 0, 0]
...
_C.model.rbsolver_iter.use_realarm.ip = "192.168.1.208"
